...
const BannerGeneral = ({ background, title, description, children }) => {
  return (
    <div className="relative flex justify-center mb-2 w-11/12 rounded-xl overflow-hidden mx-auto">
      <div
        className="flex flex-col justify-evenly w-full h-[30vh] lg:h-[60vh] border rounded-2xl shadow-xl bg-cover bg-center relative"
        style={{
      ...
      >
        ...
        <div className="relative flex justify-center z-10 text-center h-[15vh] lg:h-[50vh] bg-slate-50 bg-opacity-70 m-10 rounded-2xl">
          ...
          <p className="text-base lg:text-xl lg:w-3/4 lg:leading-loose text-slate-700 self-center lg:font-bold  m-2 lg:m-10">
            {description}
          </p>
        </div>
