      ...
      >
        ...
        <div className=" w-full flex flex-wrap justify-center z-10 text-center h-[15vh] lg:h-[55vh] bg-slate-50 bg-opacity-70 m-10 rounded-2xl">
          <div className="flex h-auto">
            ...
            <p className="text-base lg:text-xl lg:leading-loose text-slate-700 self-center lg:font-bold  m-2 lg:mx-10 lg:mt-10">
              {description}
            </p>
          </div>

          <img className="flex justify-end w-48 " src={img} alt="img" />
        </div>
