...
const RecordSection = () => {
    return (
        <section className="grid justify-items-center lg:h-[60vh] md:h-[90vh] lg:my-6 md:my-28 mb-6">
            <BubbleBanAgrario />
            ...
            <div className="grid items-end lg:w-full md:w-11/12 lg:h-[45vh] md:h-[90vh]">
