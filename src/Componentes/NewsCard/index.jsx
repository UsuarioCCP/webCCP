...
const NewsCard = ({ selectedCategory }) => {
  const news = useMemo(() => [
    ...
    { id: "new8", category: "economia", src: "https://i.postimg.cc/hGmd9Ypk/casa-velez.jpg", title: "Noticia numero 4", notice: "Participe en nuestros eventos y talleres diseñados para fomentar el crecimiento empresarial y la innovación.", fecha: "2024-02-01" }
  ], []);
