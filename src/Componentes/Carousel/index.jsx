          ...
          <div className="flex flex-wrap content-center justify-center w-full lg:w-3/5 h-[40vh] md:h-[50vh] lg:h-[60vh] mb-2 md:mb-8 lg:mb-0 p-0 md:p-5 rounded-xl backdrop-contrast-[.60]">
            ...
            <motion.div
              ...
              <div className="mt-5">
                ...
                <a href="/" className="btn btn-white-rose mb-2 lg:mr-2 transition-transform transform hover:scale-105 "><span className='text-gradient-rose'>Próximos Eventos</span></a>
              </div>
            </motion.div>
          </div>
        </div>
