  ...
  return (
    <div className="relative flex justify-center mb-2 ">
      <div className="flex w-11/12 rounded-xl bg-gradient-rose">
        <div className="flex flex-col justify-evenly w-full h-[15vh] lg:h-[25vh] border rounded-xl shadow-xl  bg-baner-separador-dos">
          <h2 className="text-2xl md:text-4xl font-extrabold text-gradient-rose ">¡Registra tu empresa hoy mismo!</h2>
